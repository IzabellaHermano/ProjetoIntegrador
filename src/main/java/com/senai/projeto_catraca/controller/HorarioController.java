...
public class HorarioController {
     ...
     public String cadastrarHorario(int idProfessor, int idTurma, String horario){
      horarioBaseDAO.inserir(new HorarioBase(0, idProfessor, idTurma, horario));
      return "Horário inserido";
     }
     public String atualizarHorario(int id, int idProfessor, int idTurma, String horario){
